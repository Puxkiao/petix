<nav class="bg-gray-800">
    ...
    <div class="relative flex h-16 items-center justify-between">
      <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
        ...
        <button type="button" class="relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:ring-2 focus:ring-white focus:outline-hidden focus:ring-inset" aria-controls="mobile-menu" aria-expanded="false">
          ...
          -->
          <a href="{{ url('/myticket') }}" class="d-inline-block"> PETIX
              <span>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M9 7h6M9 12h6M9 17h6" />
      ...
      <div class="relative ml-3 group">
        <div>
          <button type="button" class="relative flex rounded-full bg-gray-800 text-sm focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-hidden">
            <span class="absolute -inset-1.5"></span>
            <span class="sr-only">Open user menu</span>
            <img class="h-8 w-auto" src="{{ asset('images/user.png') }}" alt="Your Company">
          </button>
        </div>
          ...
          -->
        {{-- please make if user login show this dropdown should be hidden and change to logout --}}
